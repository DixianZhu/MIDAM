...
class Adam(torch.optim.Optimizer):
    ...
    def __init__(self, model, lr=1e-3, betas=(0.9, 0.999), eps=1e-8, gamma=0,
        ...
        defaults = dict(lr=lr, betas=betas, eps=eps, gamma=self.gamma, model_ref=self.model_ref, model_acc=self.model_acc,
        ...
        for group in self.param_groups:
            ...
            for i, p in enumerate(group['params']):
                ...
                if gamma != 0:
                    ...
                    grad = grad.add(tmp, alpha=1/gamma) # d_p = (d_p + p*weight_decy)
